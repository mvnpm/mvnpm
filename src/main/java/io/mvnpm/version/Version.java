...
public record Version(Integer major,
    ...
    public String toString() {
        if(this.major==null || (this.major==0 && this.minor==null && this.patch==null)) return EMPTY;
        if(this.minor==null) return String.valueOf(this.major) + getPostString();
        if(this.patch==null) return String.valueOf(this.major) + DOT + String.valueOf(this.minor) + getPostString();
        return String.valueOf(this.major) + DOT + String.valueOf(this.minor) + DOT + String.valueOf(this.patch) + getPostString();
    }
