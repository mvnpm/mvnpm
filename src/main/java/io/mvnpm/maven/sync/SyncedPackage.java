<<<<<<<< HEAD:src/main/java/io/mvnpm/maven/sync/SyncedPackage.java
package io.mvnpm.maven.sync;
========
package io.mvnpm.maven.api;
>>>>>>>> 57d5c9c (Issue #41655: opening repository API for custom extension):src/main/java/io/mvnpm/maven/api/SyncedPackage.java
